    ...
    const getAllAppointments = async () => {
      try {
        const { data } = await axios.get(
          "http://localhost:8000/api/v1/appointmentWithDoctor/getAllAppointments",
  ...
  const handleUpdateStatus = async (appointmentId, status) => {
    try {
      const response = await axios.put(
        `http://localhost:8000/api/v1/appointmentWithDoctor/updateAppointmentWithDoctor/${appointmentId}`,
        { status },
        { withCredentials: true }
      );
